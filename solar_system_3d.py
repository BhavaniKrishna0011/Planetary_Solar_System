...
class SolarSystemBody:
    ...
    def __init__(
        ...
        self.mass = mass
        self.position = tuple(p / scale for p in position)
        self.velocity = Vector(*(v / scale for v in velocity))
...
class Sun(SolarSystemBody):
    def __init__(
        ...
        super(Sun, self).__init__(solar_system, mass, position, velocity, scale)
        self.colour = "yellow"
...
class Planet(SolarSystemBody):
    ...
    def __init__(
        ...
        super(Planet, self).__init__(solar_system, mass, position, velocity, scale)
